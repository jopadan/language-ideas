...
```
- implement C++ linear algebra n-dimensional arithmetic static vector/matrix type with adaptive element/vector alignment according to n similiar to [kokkos/mdarray](https://github.com/kokkos/mdarray) and [kokkos/mdspan](https://github.com/kokkos/mdspan)
